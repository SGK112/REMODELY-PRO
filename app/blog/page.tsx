    ...
    <div className="min-h-screen bg-gray-950 text-white animate-fade-in">
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-10 animate-fade-in">
          <h1 className="text-4xl font-bold text-green-400 mb-2">RemodelyPro Blog</h1>
          <p className="text-green-200 font-medium">Insights, tips, and news for modern construction and remodeling</p>

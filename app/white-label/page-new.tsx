                ...
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        {plans.map((plan, index) => (
                            <div
                                key={index}
                                className={`bg-white rounded-2xl p-8 border-2 transition-all hover:shadow-lg ${plan.popular
                            ...
                            >
                                ...
                                <Link
                                    ...
                                    className={`w-full py-3 rounded-xl font-semibold transition-colors flex items-center justify-center ${plan.popular

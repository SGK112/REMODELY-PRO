                ...
                <div className="bg-white/60 backdrop-blur-lg rounded-2xl shadow-xl border border-white/20 p-6 mb-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button
                            ...
                            className={`p-4 rounded-xl border-2 transition-all duration-200 ${formData.userType === 'CUSTOMER'
                        ...
                        <button
                            ...
                            className={`p-4 rounded-xl border-2 transition-all duration-200 ${formData.userType === 'CONTRACTOR'

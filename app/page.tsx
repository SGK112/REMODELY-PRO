...
export default function HomePage() {
	...
	return (
		<div className="min-h-screen relative overflow-x-hidden parallax-container">
			...
			{/* Dynamic Parallax Overlay that changes opacity on scroll */}
			<div className="fixed inset-0 bg-gradient-to-br from-slate-900/70 via-blue-900/50 to-slate-900/70 transition-opacity duration-300"></div>

			{/* Scrollable Content with enhanced z-index layering */}
			<div className="relative z-10 min-h-screen">
				{/* Mobile-First Hero Section */}
				<section className="relative pt-6 pb-12 px-4 overflow-hidden min-h-screen flex items-center">
					{/* Background Effects - Enhanced for parallax */}
					<div className="absolute inset-0 bg-gradient-to-r from-blue-600/5 to-purple-600/5"></div>
					<div className="absolute top-10 right-4 w-32 h-32 bg-blue-500/5 rounded-full blur-2xl"></div>
					<div className="absolute bottom-10 left-4 w-40 h-40 bg-purple-500/5 rounded-full blur-2xl"></div>
				...
				<section id="apps" className="relative py-12 px-4 bg-gradient-to-b from-slate-900 to-slate-800 z-10">
				...
				<section className="relative py-12 px-4 bg-gradient-to-b from-slate-800/80 to-slate-900/80 backdrop-blur-sm z-10">
						...
						<div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
							<div className="text-center">
								...
								<p className="text-gray-300 text-lg mb-6">
									This stunning kitchen showcases the power of AI-driven design. Notice how the background moves with your scroll for an immersive experience.
								</p>
								<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
									<div className="bg-white/5 rounded-xl p-6">
										...
										<p className="text-gray-300 text-sm">Every design optimized by artificial intelligence</p>
									</div>
									<div className="bg-white/5 rounded-xl p-6">
										...
										<h3 className="text-white font-semibold mb-2">Beautiful Results</h3>
										<p className="text-gray-300 text-sm">Professional-grade designs that inspire</p>
									</div>
									<div className="bg-white/5 rounded-xl p-6">
										...
										<p className="text-gray-300 text-sm">Get results in minutes, not weeks</p>
									</div>
								</div>
							</div>
						</div>
				...
				{/* Mobile CTA Section */}
				<section className="relative py-12 px-4 bg-gradient-to-r from-blue-600/90 to-purple-600/90 backdrop-blur-sm z-10">

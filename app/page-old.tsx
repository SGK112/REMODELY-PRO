          ...
          <div className="text-center max-w-6xl mx-auto">
            <div className="mb-8">
              <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur px-4 py-2 rounded-full text-indigo-200 mb-6">
                ...
                <span className="text-sm font-medium">Complete Remodeling & Construction Solution</span>
              </div>

              <h1 className="text-5xl md:text-7xl font-bold text-white mb-8 leading-tight">
                Use our AI-powered tools to
                <span className="bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent block">
                  Design, Plan, Manage & Execute
                </span>
                All Your Remodeling Projects
              </h1>

              <p className="text-xl text-white/80 mb-10 max-w-3xl mx-auto leading-relaxed">
                Use our AI-powered tools to design, plan, manage, and execute all your remodeling and construction projects with REMODELY.ai
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link href="/ai-tools" className="group bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
                <Brain className="inline mr-2 h-5 w-5" />
                Start Your Project
                <ArrowRight className="inline ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </Link>
              <Link href="/contractors" className="group bg-white/10 backdrop-blur text-white border border-white/20 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-white/20 transition-all duration-300">
      ...
      <section id="marketplace" className="py-20 bg-black/20 backdrop-blur">
        <div className="container mx-auto px-6">
          ...
          <div className="text-center mt-12">
            <Link href="/ai-tools" className="inline-flex items-center bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
              View All Tools
        ...
        <div className="container mx-auto px-6 text-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/ai-tools" className="border-2 border-white text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-white hover:text-indigo-600 transition-all duration-300">
                Start Free Trial
              </Link>
            </div>
          </div>

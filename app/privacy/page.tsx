        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              NewCountertops.com ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              This information may include: name, email address, phone number, mailing address, project details, budget information, and other relevant details about your countertop project.
            </p>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-4">
              ...
              <li>Process and fulfill your quote requests</li>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibrand text-gray-900 mb-4">Information Sharing</h2>
            <p className="text-gray-600 mb-4">
            ...
            <p className="text-gray-600 mb-4">
              We may share information with third-party service providers who help us operate our business, such as payment processors, email services, and analytics providers.
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600">
              To exercise these rights, please contact us at privacy@newcountertops.com.
            </p>
          </section>

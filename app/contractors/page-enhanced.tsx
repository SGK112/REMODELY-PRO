...
import AdvancedLocationService from '@/lib/advancedLocationService'
...
export default function ContractorsPage() {
    ...
    const calculateContractorDistances = async (userPos: { lat: number; lng: number }) => {
                ...
                if (contractor.latitude && contractor.longitude) {
                    ...
                    if (distance <= 100) { // Only get driving time for contractors within 100 miles
                        try {
                            ...
                            drivingTime = drivingInfo.duration
                        } catch (error) {
                    ...
                    return {
                        ...
                        drivingTime: drivingTime ? Math.round(drivingTime / 60).toString() + ' min' : undefined
                    }
                }
                return contractor
            })

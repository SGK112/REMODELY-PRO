...
export default function WilsonartQuartzPage() {
  const collections = [
    {
      name: "HD Collection",
    ...
    },
    {
      ...
      description: "Clean, consistent colors with superior performance",
      colors: ["Arctic White", "Pearl", "Charcoal", "Midnight Black"],
      image: "https://images.unsplash.com/photo-1565538810643-b5bdb714032a?q=80&w=800&h=600&fit=crop"
    },
    {
      name: "Natural Collection",
      description: "Inspired by natural stone formations",
      colors: ["White Carrara", "Grey Expo", "Sahara Beige", "Jet Black"],
      image: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?q=80&w=800&h=600&fit=crop"
    }
  ]
  ...
  const features = [
    {
      ...
      description: "Leading manufacturer with decades of innovation"
    },
    {
      icon: <Shield className="w-8 h-8 text-blue-600" />,
      title: "NSF Certified",
      description: "Food-safe surfaces meeting strict health standards"
    },
    {
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <Link href="/search?brand=wilsonart-quartz" className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
              Find Contractors
            </Link>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center mb-6">
                <h1 className="text-5xl font-bold text-white">Wilsonart Quartz</h1>
              </div>
              <h2 className="text-3xl lg:text-4xl font-bold mb-6">
                Innovation in Every Surface
              </h2>
              <p className="text-xl text-blue-100 mb-8">
                For over 60 years, Wilsonart has been pioneering surface innovations.
                Our quartz surfaces combine beauty, durability, and performance.
              </p>
      ...
      <div className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose Wilsonart Quartz?</h2>
            <p className="text-xl text-gray-600">Decades of innovation and quality craftsmanship</p>
          </div>
      ...
      <div id="collections" className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Discover surfaces that inspire</p>
          </div>
      ...
      <div className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Explore Wilsonart Quartz</h2>
            <p className="text-xl text-gray-600">Visit the official Wilsonart website for complete specifications</p>
          </div>
          <div className="bg-gray-100 rounded-lg p-4">
            <iframe
              src="https://www.wilsonart.com/quartz"
              className="w-full h-96 border-0 rounded"
              title="Wilsonart Quartz Official Website"
      ...
      <div className="bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Experience Wilsonart Quality</h2>
            <p className="text-xl text-blue-100 mb-8">Connect with certified Wilsonart professionals near you</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/quote" className="bg-white text-blue-600 px-8 py-3 rounded-lg hover:bg-gray-100 font-semibold">
                Get Free Quote
              </Link>
              <Link href="/search?brand=wilsonart-quartz" className="border-2 border-white text-white px-8 py-3 rounded-lg hover:bg-white hover:text-blue-600">
                Find Professionals
              </Link>
            </div>
          </div>

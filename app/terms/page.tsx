        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              By accessing and using NewCountertops.com ("the Service"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              NewCountertops.com is a platform that connects homeowners with qualified contractors for countertop installation and related services. We facilitate introductions between customers and contractors but are not a party to any agreements between them.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-4">
              ...
              <li>Transmit harmful, harassing, or offensive content</li>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Contractor Verification</h2>
            <p className="text-gray-600 mb-4">
              While we make efforts to verify contractor credentials, licensing, and insurance, we do not guarantee the quality of work or the accuracy of all contractor information. Users should independently verify contractor credentials before entering into agreements.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Quote and Project Terms</h2>
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Quote Requests</h3>
            <p className="text-gray-600 mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              Use of our basic matching service is free for homeowners. We may charge contractors fees for premium features or lead access. All payment terms will be clearly disclosed before any charges are incurred.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              NewCountertops.com shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the Service or any contractor services obtained through the platform.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              You agree to indemnify and hold harmless NewCountertops.com from any claims, damages, or expenses arising from your use of the Service or violation of these terms.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              The Service and its original content, features, and functionality are owned by NewCountertops.com and are protected by international copyright, trademark, and other intellectual property laws.
            </p>
          </section>
